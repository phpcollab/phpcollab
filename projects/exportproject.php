...
array_push($export_csv, array($projectDetail["pro_name"], $projectDetail["pro_description"], $projectDetail["pro_mem_login"], $priority[$idPriority], $status[$idStatus], Util::createDate($projectDetail["pro_created"], $session->get("timezone")), $projectDetail["pro_org_name"]));
