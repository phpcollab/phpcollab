...
class block
{
    ...
    function block()
    {
        ...
        $this->bgColor = "#5B7F93";
        $this->fgColor = "#C4D3DB";
        $this->oddColor = "#DBEDFF";
        $this->evenColor = "#EEF7FF";
        $this->highlightOn = "#CEE7FF";
     ...
     * @access public
     */
    function printHelp(string $item): string
    {
        global $help, $strings;
