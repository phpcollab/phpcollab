...
$help["setup_error_admin_password"] = "Must insert an Admin password";
$help["setup_error_admin_email"] = "Must insert an Admin email";
...
$help["setup_social_info"] = "<strong>Connect with us:</strong><p>Join us on <a href=\"https://slack.phpcollab.com\" class=\"noIcon\">Slack<i style=\"margin-left: 5px;\" class=\"fab fa-slack-hash\"></i></a> <span style=\"color: darkgray\">|</span> Like us on <a href=\"https://www.facebook.com/phpcollab/\" class=\"noIcon\">Facebook<i style=\"margin-left: 5px;\"  class=\"fab fa-facebook-square\"></i></a></p>";
...
$help["homeViewOptions"] = '<div>This does not disable the feature, just removes it from theo home view.</div>';
