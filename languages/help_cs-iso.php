...
$help["setup_loginmethod"] = "Způsob uložení hesla v databázi.<br/>Set to &quot;Crypt&quot; in order htaccess authentification to work (if htaccess authentification are enabled).";
